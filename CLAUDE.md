...
A free, self-contained, zero-dependency interactive Japanese course from zero to JLPT N2 in 1320 days (N5 + N4 + N3 + N2 complete; N1 planned).
...
├── curriculum.js       # 1320-day lesson data array + phase colour/name constants
...
├── N3-N2-N1-REQUIREMENTS.md  # Implementation plan for N1 (N2 complete)
...
| **Curriculum integrity** | 1320 sequential days, required fields, type validity, vocab/chars structure, phase/week ranges, N5/N4/N3/N2 boundary checks |
...
| 991–1090  | 22    | N2 Vocabulary (~500 words)                         |
| 1091–1140 | 23    | N2 Verbs & Expressions                             |
| 1141–1230 | 24    | N2 Grammar Patterns                                |
| 1231–1275 | 25    | N2 Kanji (~200 kanji)                              |
| 1276–1320 | 26    | N2 Test Prep                                       |

Phase constants for N1 (phases 27–32) are defined in
`curriculum.js` but lesson data for that level has not yet been added.
See `N3-N2-N1-REQUIREMENTS.md` for the full N1 implementation plan.

## Key implementation notes

- All 1320 day definitions live in `curriculum.js` — the first 365 as a JSON array literal, days 366–1320 appended via `curriculum.push()` calls
